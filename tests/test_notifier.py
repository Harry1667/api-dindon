...
class TestShouldNotify:
    ...
    def test_normal_mode_first_notify_beyond_10(self):
        """NORMAL 模式：首次通知，超過 10 號"""
        assert self.svc._should_notify("normal", remaining=15, last_remaining=None) is False
    ...
    def test_light_mode_triggers_at_10(self):
        """LIGHT 模式：剩 10 號時觸發"""
        assert self.svc._should_notify("light", remaining=10, last_remaining=None) is True
    ...
    def test_final_mode_triggers_at_3(self):
        """FINAL 模式：剩 3 號時觸發"""
        assert self.svc._should_notify("final", remaining=3, last_remaining=None) is True

    def test_final_mode_no_trigger_at_5(self):
        """FINAL 模式：剩 5 號時不觸發"""
        assert self.svc._should_notify("final", remaining=5, last_remaining=None) is False
