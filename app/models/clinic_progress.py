...
class ClinicProgress(Base):
    ...
    __table_args__ = (
        Index("ix_cp_fetched_at", "fetched_at"),
        Index("ix_cp_hospital_date", "hospital_code", "date"),
    )
    ...
    clinic_room: Mapped[str] = mapped_column(String(255), nullable=False, comment="診間號碼 如 282診")
